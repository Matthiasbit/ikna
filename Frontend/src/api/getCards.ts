...
export function useGetCards() {
    ...
    useEffect(() => {
        const fetchCards = async () => {
            ...
            const response = await Promise.resolve(exampleCards);
            setCards(response);
            setLoading(false);
        };
...
export const exampleCards: CardArrayType[] = [
    {id: '1', question: 'Warum hat Ikna so einen tollen Namen?', answer: 'Ikna ist Anki nur halt nicht', difficulty: 1},
    {
        id: '2',
        question: 'Wer begeht Kriegsverbrechen in seiner Freizeit?',
        answer: 'Nein nicht Matthias, es ist Benjamin Blümchen',
        difficulty: 2
    },
    {
        id: '3',
        question: 'Welche id habe ich?',
        answer: '3 aber warum zum F gebe ich DANN NICHT 3 AUS......',
        difficulty: 2
    },
